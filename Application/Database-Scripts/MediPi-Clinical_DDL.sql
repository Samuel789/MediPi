...
ALTER TABLE ONLY patient_details ADD CONSTRAINT patient_details_pk PRIMARY KEY (patientUuid);
ALTER TABLE ONLY patient_group ADD CONSTRAINT patient_group_pk PRIMARY KEY (patient_group_uuid);
ALTER TABLE ONLY patient ADD CONSTRAINT patient_id PRIMARY KEY (patientUuid);
ALTER TABLE ONLY recording_device_type ADD CONSTRAINT type_id PRIMARY KEY (type_id);
ALTER TABLE ONLY alert ADD CONSTRAINT patient_alert_fk FOREIGN KEY (patientUuid) REFERENCES patient(patientUuid);
ALTER TABLE ONLY attribute_threshold ADD CONSTRAINT patient_attribute_threshold_fk FOREIGN KEY (patientUuid) REFERENCES patient(patientUuid);
...
ALTER TABLE ONLY patient_details ADD CONSTRAINT patient_patient_details_fk FOREIGN KEY (patientUuid) REFERENCES patient(patientUuid);
ALTER TABLE ONLY recording_device_data ADD CONSTRAINT patient_recording_device_data_fk FOREIGN KEY (patientUuid) REFERENCES patient(patientUuid);
