...
CREATE TABLE recorded_dose (
    recorded_dose_id integer NOT NULL,
...
ALTER SEQUENCE medication_recorded_dose_id_seq OWNED BY recorded_dose.recorded_dose_id;
...
--
-- Name: recorded_dose recorded_dose_id; Type: DEFAULT; Schema: public; Owner: medipiconc
--

ALTER TABLE ONLY recorded_dose ALTER COLUMN recorded_dose_id SET DEFAULT nextval('medication_recorded_dose_id_seq'::regclass);
...
ALTER TABLE ONLY recorded_dose
    ADD CONSTRAINT medication_recorded_dose_pkey PRIMARY KEY (recorded_dose_id);
...
CREATE UNIQUE INDEX medication_recorded_dose_id_uindex ON recorded_dose USING btree (recorded_dose_id);
